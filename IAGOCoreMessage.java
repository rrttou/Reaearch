...
public abstract class IAGOCoreMessage implements MessagePolicy
{
	...
	protected abstract  Preference getLastUserPref();
	protected abstract boolean getUserToldMeHisPref();
	public abstract  String GetNextMessage();
	public abstract  void setBehavior(IAGOCoreBehavior behavior);
	public abstract RepeatedFavorBehavior.LedgerBehavior getLb();
